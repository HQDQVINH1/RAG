...
class ComplianceGapChecker:
    ...
    def analyze_gap(
        ...
        # Match internal candidates by keyword/similarity
    ...
    def run_full_check(self, output_csv: Path, report_md: Path):
        """
        ...
        if self.int_df is None or self.int_df.empty:
            ...
            # Generate Empty CSV with 14-field Schema
            schema_cols = [
        ...
        # If internal policies ARE available (e.g. agribank_internal_policies.csv loaded)
...
if __name__ == "__main__":
    ...
    checker.run_full_check(out_csv, out_md)
